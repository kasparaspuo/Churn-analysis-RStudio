...
```{r}
# Question 34 
#Making barplot to see if there are any abnormalities in the states
table_states <- table(churn$State)
colors = rainbow(200)
barplot(table_states , col = colors)

#Making pie chart to check if there are abnormalities in area codes
pie(table(churn$Area.Code))
```
